...
export const ICE_CAKES: Product[] = [
  ...
  { id: 'ice-cake-4-05', name: 'Mango Cake (0.5kg)', price: 380, originalPrice: 760, category: 'Ice Cakes', type: 'food', image: '/mango_special.png', description: 'Tropical mango perfection.', isVeg: true },
  ...
  { id: 'ice-cake-4-1', name: 'Mango Cake (1kg)', price: 680, originalPrice: 1360, category: 'Ice Cakes', type: 'food', image: '/mango_special.png', description: 'Tropical mango perfection.', isVeg: true },
...
export const NORMAL_CAKES: Product[] = [
  // Half Kg (0.5kg) - ₹200
  { id: 'cake-1-05', name: 'Vanilla Cake (0.5kg)', price: 200, originalPrice: 400, category: 'Normal Cakes', type: 'food', image: '/black_forest_cake.png', description: 'Classic creamy vanilla cake.', isVeg: true },
  ...
  { id: 'cake-3-05', name: 'Mango Cake (0.5kg)', price: 200, originalPrice: 400, category: 'Normal Cakes', type: 'food', image: '/mango_special.png', description: 'Delightful tropical mango cake.', isVeg: true },

  // 1 Kg (1kg) - ₹400
  { id: 'cake-1-1', name: 'Vanilla Cake (1kg)', price: 400, originalPrice: 800, category: 'Normal Cakes', type: 'food', image: '/black_forest_cake.png', description: 'Classic creamy vanilla cake.', isVeg: true },
  ...
  { id: 'cake-3-1', name: 'Mango Cake (1kg)', price: 400, originalPrice: 800, category: 'Normal Cakes', type: 'food', image: '/mango_special.png', description: 'Delightful tropical mango cake.', isVeg: true },
];
...
export const SNACKS: Product[] = [
  { id: 'snack-1', name: 'Veg Puffs', price: 25, category: 'Snacks', type: 'food', image: '/egg_puff.png', description: 'Crispy and hot veg puffs.', isVeg: true },
