...
export const ICE_CAKES: Product[] = [
  // Half Kg (0.5kg) - ₹380
  { id: 'ice-cake-1-05', name: 'Butterscotch Cake (0.5kg)', price: 380, originalPrice: 760, category: 'Ice Cakes', type: 'food', image: 'https://images.unsplash.com/photo-1602351447937-745cb720612f?w=800&q=80', description: 'Premium butterscotch ice cream cake.', isVeg: true, isTopPick: true },
  ...
  { id: 'ice-cake-5-05', name: 'Kiwi Cake (0.5kg)', price: 380, originalPrice: 760, category: 'Ice Cakes', type: 'food', image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=800&q=80', description: 'Tangy and sweet kiwi ice cake.', isVeg: true },

  // 1 Kg (1kg) - ₹680
  { id: 'ice-cake-1-1', name: 'Butterscotch Cake (1kg)', price: 680, originalPrice: 1360, category: 'Ice Cakes', type: 'food', image: 'https://images.unsplash.com/photo-1602351447937-745cb720612f?w=800&q=80', description: 'Premium butterscotch ice cream cake.', isVeg: true, isTopPick: true },
  ...
  { id: 'ice-cake-5-1', name: 'Kiwi Cake (1kg)', price: 680, originalPrice: 1360, category: 'Ice Cakes', type: 'food', image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=800&q=80', description: 'Tangy and sweet kiwi ice cake.', isVeg: true },
];
...
export const PARTY_ITEMS: Product[] = [
  { id: 'party-1', name: 'Party Spray', price: 69, category: 'Party Items', type: 'food', image: 'https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=800&q=80', description: 'Perfect for Birthday!', isVeg: true },
  { id: 'party-2', name: 'Party Popper', price: 99, category: 'Party Items', type: 'food', image: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&q=80', description: 'Perfect for Birthday!', isVeg: true },
  ...
  { id: 'party-4', name: 'Party Cap', price: 20, category: 'Party Items', type: 'food', image: 'https://images.unsplash.com/photo-1513151233558-d860c5398176?w=800&q=80', description: 'Perfect for Birthday!', isVeg: true },
  { id: 'party-5', name: '5 Balloons Pack', price: 20, category: 'Party Items', type: 'food', image: 'https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=800&q=80', description: 'Perfect for Birthday!', isVeg: true },
];
...
export const SNACKS: Product[] = [
  ...
  { id: 'snack-2', name: 'Egg Puffs', price: 30, category: 'Snacks', type: 'food', image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=800&q=80', description: 'Delicious hot egg puffs.', isVeg: false },
];
